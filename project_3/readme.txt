...
This is the output/result when running the script:
(Note: The output specifies if a new thumbnail was generated and provides folder location. If it exists, it will give the folder location)
